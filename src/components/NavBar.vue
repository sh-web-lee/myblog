<template>
  <v-app-bar app :class="navClass" hide-on-scroll flat height="60" width="100%">
    <!-- 手机端导航栏 -->
    <div class="d-md-none nav-mobile-container">
      <div style="font-size:18px;font-weight:bold">
        <router-link to="/">lijianyang</router-link>
      </div>
      ...
      <div class="float-right nav-title">
        ...
        <div class="menus-item">
          <router-link to="/albums">
            <i class="iconfont iconhanbao" /> 壁纸
          </router-link>
        </div>
        <div class="menus-item">
        ...
        <!-- <div class="menus-item">
          <router-link to="/works">
            <i class="iconfont icon-zuopin" /> 作品
          </router-link>
        </div> -->
        <div class="menus-item">
